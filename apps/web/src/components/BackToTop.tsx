  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: '0 4px 16px rgba(107, 175, 146, 0.15)',
      }}
      onMouseEnter={(e) => {
        (e.currentTarget as HTMLButtonElement).style.transform = 'translateY(-2px) scale(1.05)';
        (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 8px 24px rgba(107, 175, 146, 0.25)';
      }}
      onMouseLeave={(e) => {
        (e.currentTarget as HTMLButtonElement).style.transform = visible ? 'translateY(0) scale(1)' : 'translateY(16px) scale(1)';
        (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 4px 16px rgba(107, 175, 146, 0.15)';
      }}
    >
      <UpOutlined />
    </button>
