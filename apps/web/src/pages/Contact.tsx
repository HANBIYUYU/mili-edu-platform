...
import { MailOutlined, EnvironmentOutlined, QuestionCircleOutlined } from '@ant-design/icons';
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
              {contactInfo.map((item) => (
                <div key={item.label} style={{ display: 'flex', alignItems: 'center', gap: 18, padding: '28px 24px', background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(8px)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.2)' }}>
